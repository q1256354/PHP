					...
					<div class="panel-body">
						<form class="form-horizontal" id="register_form">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text"  class="form-control" id="company_name" name="company_name" value="{{ $datas->company_name }}" >			
								</div>	
							</div>
							<div class="form-group">
								<label class="col-md-4 control-label">公司全名(英文):</label>
								<div class="col-md-6">
                                    <input type="text"  class="form-control" id="company_name_eng" name="company_name_eng" value="{{ $datas->company_name_eng }}" >
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text"  class="form-control" id="fax" name="fax" value="{{ $datas->fax }}" >			
								</div>
							</div>	
                            <div class="form-group">
								<label class="col-md-4 control-label">手機:</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="cellphone" name="cellphone" value="{{ $datas->cellphone }}" >			
								</div>
							</div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
								...
								<div class="col-md-6">
									<input type="text"  class="form-control" id="url" name="url" value="{{ $datas->url }}" >			
								</div>
							</div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
								...
								<div class="col-md-6">
									<input type="text"  class="form-control" id="tax_number" name="tax_number" value="{{ $datas->tax_number }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">repeat:</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="repeat_status" name="repeat_status" value="{{ $datas->repeat_status }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">顧客姓名(英文):</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="name_eng" name="name_eng" value="{{ $datas->name_eng }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">職稱(英文):</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="title_eng" name="title_eng" value="{{ $datas->title_eng }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">部門(英文):</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="department_eng" name="department_eng" value="{{ $datas->department_eng }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">地址(英文):</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="address_eng" name="address_eng" value="{{ $datas->address_eng }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">備註:</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="remark" name="remark" value="{{ $datas->remark }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">類別:</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="kind" name="kind" value="{{ $datas->kind }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">排程:</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="queue" name="queue" value="{{ $datas->queue }}" >			
								</div>
							</div>
                            <div class="form-group">
								<label class="col-md-4 control-label">領域:</label>		
								<div class="col-md-6">
									<input type="text"  class="form-control" id="specialization" name="specialization" value="{{ $datas->specialization }}" >			
								</div>
							</div>                                    
							<div class="form-group">
